...
public class ModelThreeHeadedSheep extends ModelQuadruped {

    private float headRotationAngleX;
    public ModelThreeHeadedSheep() {
        super(12, 0.0F);
        this.head = new ModelRenderer(this, 0, 0);
        this.head.addBox(-3.0F, -4.0F, -6.0F, 6, 6, 8, 0.0F);
        this.head.addBox(-10.0F, -4.0F, -6.0F, 6, 6, 8, 0.0F);
        this.head.addBox(4f, -4.0F, -6.0F, 6, 6, 8, 0.0F);
