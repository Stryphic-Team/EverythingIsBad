...
import com.dna.everythingisbad.gui.container.IncubatorContainer;
...
public class IncubatorGuiContainer extends DeviceContainerGuiBase {

    public IncubatorGuiContainer(InventoryPlayer player, TileDeviceBase tileentity) {
        super(new IncubatorContainer(player, tileentity), player, tileentity);
    }
