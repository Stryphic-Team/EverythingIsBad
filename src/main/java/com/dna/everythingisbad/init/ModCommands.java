...
import com.dna.everythingisbad.commands.CommandGetStatistics;
...
public class ModCommands {
    ...
    public static final ModCommandBase COMMAND_GET_STATISTICS = new CommandGetStatistics("getstatistics");
