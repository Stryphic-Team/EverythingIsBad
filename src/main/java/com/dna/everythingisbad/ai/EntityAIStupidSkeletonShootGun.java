...
public class EntityAIStupidSkeletonShootGun<T extends EntityMob & IRangedAttackMob> extends EntityAIBase {
    ...
    public EntityAIStupidSkeletonShootGun(T p_i47515_1_, double p_i47515_2_, int p_i47515_4_, float p_i47515_5_)
    {
    ...
    public void updateTask()
    {
        ...
        if (entitylivingbase != null)
        {
            ...
            if (this.entity.ticksExisted % 10 == 0){
                this.entity.attackEntityWithRangedAttack(entitylivingbase, ItemBow.getArrowVelocity(20));
            }
