...
public class EntityAIPoliceShootGun<T extends EntityMob & IRangedAttackMob> extends EntityAIBase {
    ...
    public EntityAIPoliceShootGun(T p_i47515_1_, double p_i47515_2_, int p_i47515_4_, float p_i47515_5_)
    {
